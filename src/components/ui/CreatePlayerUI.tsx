...
export interface PlayerCreationData {
  ...
  topAttributes: string[]; // 3 atributos
  favoriteClub: string;
...
// Exemplo de clubes e jogadores (mock)
    ...
    <div className="relative w-screen h-screen overflow-hidden bg-zinc-950 select-none">
      ...
      <header className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-6 md:px-10 py-4 bg-gradient-to-b from-black/80 to-transparent">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500">
          ...
          <span className="font-mono text-white/60">CRIAR JOGADOR</span>
        </div>
      </header>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-white font-bold text-sm uppercase tracking-wider focus:outline-none focus:ring-2 focus:ring-blue-400/50"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full bg-black/50 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-white font-bold text-sm uppercase appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400/50"
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-white font-bold text-sm focus:outline-none focus:ring-2 focus:ring-blue-400/50"
                    />
                  </div>
                </div>
                <div>
            ...
            <div className="space-y-4">
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 rounded-xl border-2 transition-all ${
                        preferredFoot === foot
                          ...
                          : 'border-white/10 bg-black/30 text-gray-400 hover:border-blue-400/50'
                      }`}
                    >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl font-black text-sm uppercase tracking-widest transition-all duration-300 bg-blue-500 text-black hover:bg-blue-400 shadow-lg shadow-blue-500/30 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
